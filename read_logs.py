...
if os.path.exists('interruption.log'):  #remove old output file
     os.remove('interruption.log')
path_list = os.listdir(path + '/logs/')
...
interup = open('interruption.log', 'w')
...
for i in range(1, count):
    ...
    if abs(pause) > 5:
        ...
        interup.write("%s  log interuption occur in line: %d \n" % (delttime, (i+1)))
